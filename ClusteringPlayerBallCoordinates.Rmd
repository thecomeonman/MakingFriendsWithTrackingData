...
```{r DataPrepDefense, cache=FALSE, echo=FALSE, warning=FALSE, message=FALSE, fig.width = 15, fig.height = 8, results = 'hide'}
...
```{r ClusteringDefense, cache=FALSE, echo=FALSE, warning=FALSE, message=FALSE, fig.width = 15, fig.height = 8, results = 'hide'}
...
```{r PrintingRresultsDefense, cache=FALSE, echo=FALSE, warning=FALSE, message=FALSE, fig.width = 15, fig.height = 10}
# plot 12 clusters at a time in 4 batches
...
I usually don't post things so early in the process but making an exception because I'm surprised:
1. at how informative this already is
2. that I haven't seen this on Twitter yet. A quick Google Scholar search didn't give anything strong either
